...
### Step 1b: Add GitHub Pages link to the daily report

Before committing, modify today's HTML report to include a link to its GitHub Pages version. Replace the footer line:
...
```
Generated by WorkBuddy Daily Paper Tracker &middot; YYYY-MM-DD &middot; <a href="https://qihongl.github.io/paper-tracking/outputs/YYYY-MM-DD-paper-tracker.html">View online</a>
```

Use a simple string replacement in the HTML file (replace the old footer text with the new one including the link). Make sure the URL uses the correct date.
